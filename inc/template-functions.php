 ...
 * @return array
 */
function _incubation_body_classes( $classes ) {
...
add_filter( 'body_class', '_incubation_body_classes' );

/**
 * Aggiunge un pingback url auto-discovery header per single posts, pagine, o allegati.
 */
function _incubation_pingback_header() {
	if ( is_singular() && pings_open() ) {
		printf( '<link rel="pingback" href="%s">', esc_url( get_bloginfo( 'pingback_url' ) ) );
	}
}
add_action( 'wp_head', '_incubation_pingback_header' );